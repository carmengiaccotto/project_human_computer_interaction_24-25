...
\begin{itemize}
    \item \textbf{Intervistatore (Carmen):} Possiamo iniziare?
    \item \textbf{Intervistato (Carlo):} Certo.
    ...
    \item \textbf{Intervistatore (Valentina):} Le volevo chiedere se attualmente, nel museo in cui lavora, c’è un sistema digitale o tecnologico per acquistare non solo i biglietti, ma anche audioguide. Se ci sono, quali sono le difficoltà che vengono riscontrate più spesso, soprattutto dai giovani?
