...
Severity: 4 \\
\textbf{Risposta}: abbiamo implementato un overlay animato che si apre cliccando sull’icona associata a ogni opera, mostrando i dettagli rilevanti (l’utente, in fase di creazione dell’opera, potrà collegarsi direttamente alla schermata di informazioni). Questa soluzione migliorerà l’accesso alle informazioni senza sovraccaricare l’interfaccia principale.\\
